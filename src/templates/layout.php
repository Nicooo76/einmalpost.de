...
<?php endif; ?>
<?php /* Deutsch unter /, Englisch später unter /en/. Die Struktur steht schon,
         damit die englische Fassung später ohne Umzug dazukommt. */ ?>
...
<body class="page <?= $h($meta->bodyClass) ?>">
...
<footer class="site-footer">
    <nav class="site-footer__nav" aria-label="Weitere Seiten">
